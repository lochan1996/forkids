 ...
 <div id="back_glob">
	...
	<div id="back_form">
        <form method="POST">
		   ...
		   <input type="email" name="email"       placeholder="                 eg:@gmail.com"/>
		...
		<li class="special">Must contain a number or special character.</li>
		  ...
		  <label>COURSE</label>
		  <input type="checkbox" name="cse" value="Cse"><p>cse</p>
          <input type="checkbox" name="other" value="other"><p>others</p>
